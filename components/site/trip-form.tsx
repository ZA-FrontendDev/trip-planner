    ...
    <div className="card-surface p-6 sm:p-8">
      <div className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
          This first version is a styled front-end flow using mock booking data. Form submission routes
          to the itinerary screen that matches the provided reference.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <input className="input-base" type="date" />
        <input className="input-base" type="number" min="1" defaultValue="4" placeholder="Adults" />
        <input className="input-base" type="number" min="0" defaultValue="0" placeholder="Children" />
        <select className="input-base" defaultValue="">
          <option value="" disabled>
            Room Type
          </option>
      ...
      <div className="mt-4">
        <textarea className="textarea-base min-h-32" placeholder="Special requests, dietary notes, accessibility needs, or custom stopovers" />
      </div>

      <div className="mt-6 flex flex-col gap-3 rounded-[24px] bg-slate-50 p-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-slate-600">
          Next step in this phase: submit to Convex, create the booking, and resolve a matching package.
        </p>
        <Link
